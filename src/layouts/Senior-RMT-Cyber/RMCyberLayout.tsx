...
export default function RMCyberLayout() {
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-64 shrink-0 bg-blue-800 font-family-playfair text-white overflow-y-auto overflow-x-hidden">
        ...
        <h1 className="text-[20px] font-bold mb-3 pt-5 text-center">
          RM Store and Cyber Panel
        </h1>

        <ul className="space-y-1 font-family-playfair text-[16px]">
          {/* <li>
            <NavLink to="/rmcyber/products" className={navLinkClass}>
              <Box size={15} />
          ...
          {/** servicerequest */}
          <li>
            <NavLink to="/rmcyber/servicerequest" className={navLinkClass}>
              <Briefcase size={15} />
